"""Reusable case39 benchmark runner.

This module centralizes the train/eval/checkpoint workflow so model plugins
can be compared under the same benchmark procedure.
"""
...
from alloy.experiments.experiment_config import Case39TrainingConfig, ExperimentConfig
...
def run_case39_benchmark(
    *,
    ...
    """Run case39 benchmark with standardized logging/checkpoint workflow.
    ...
    """
    config: Case39TrainingConfig = experiment.training
